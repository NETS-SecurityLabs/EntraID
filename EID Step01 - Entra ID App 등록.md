...
## 앱 등록하기
  ...
  <img src="./.srcs/eid.step01.01.png" style="pointer-events: none;" alt="엔터프라이즈 앱 등록" />

## Single Sign On 설정: IdP에 SP의 정보 기록하기
  1. 앱 목록에서 생성한 "<name>-Salesforce" 앱 선택
  2. 개요 페이지에서 "2. Single Sign On 설정" 타일 또는 "시작" 링 선택
     <img src="./.srcs/eid.step02.01.png" style="pointer-events: none;" alt="SSO 설정하기" />
  3. Single Sign-On 방법 선택 에서 SAML 타일 선택
  4. 기본 SAML 구성 섹션의 편집 링크 선택
     <img src="./.srcs/eid.step02.02.png" style="pointer-events: none;" alt="SAML SP 정보 입력" />
