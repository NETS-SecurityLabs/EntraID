...
## Salesforce 도메인 확인하기
  1. [EID Lab 사전 준비사항](EID%20Lab%20사전%20준비사항.md) 참고하여 접근 도메인 확인
...
## Single Sign On 설정: IdP에 SP의 정보 기록하기
  ...
  2. 개요 페이지에서 "2. Single Sign On 설정" 타일 또는 "시작" 링 선택
     <a href="#void"><img src="./.srcs/eid.step02.01.png" alt="SSO 설정하기" /></a>
  3. Single Sign-On 방법 선택 에서 SAML 타일 선택
  4. 기본 SAML 구성 섹션의 편집 링크 선택
     <a href="#void"><img src="./.srcs/eid.step02.02.png" alt="SAML SP 정보 입력" /></a>
